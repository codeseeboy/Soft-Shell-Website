...
export default function HowItWorks() {
  ...
  const steps = [
    ...
    {
      title: "Get Valuation",
      description: "Our experts analyze the market and provide you with the best possible valuation for your licenses.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
      ...
      <div className="container mx-auto px-4" ref={ref}>
        <div className="text-center mb-16">
          <h2 className="section-heading">
            How <span className="blue-gradient-text">It Works</span>
          </h2>
        ...
        >
          {steps.map((step, index) => (
            <motion.div key={index} className="relative" variants={itemVariants}>
              <div className="bg-card rounded-lg p-8 h-full shadow-md hover:shadow-lg transition-shadow border card-hover">
